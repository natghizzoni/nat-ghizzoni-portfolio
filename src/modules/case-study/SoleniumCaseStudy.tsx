...
// ── Data ──────────────────────────────────────────────────────────
const meta = [
  { label: "Rol",          value: "UX / Product Designer" },
    ...
    <>
      ...
      <main className="pt-[80px]">
        ...
        <section className="bg-white pt-16 pb-16 md:pt-[72px] md:pb-[80px] px-6">
          <div className="max-w-[1346px] mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h2
                className="text-[#1a1433] font-black text-[24px] md:text-[36px] leading-tight"
                style={{ fontFamily: "var(--font-hanken-grotesk)" }}
              >
                El desafío
              </h2>
        ...
        <section className="bg-[#2a2560] pt-16 pb-16 md:pt-[72px] md:pb-[80px] px-6">
          <div className="max-w-[1346px] mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h2
                className="text-white font-black text-[24px] md:text-[36px] leading-tight"
                style={{ fontFamily: "var(--font-hanken-grotesk)" }}
              >
                El proceso
              </h2>
